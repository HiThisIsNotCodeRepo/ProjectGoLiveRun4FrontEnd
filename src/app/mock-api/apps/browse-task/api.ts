...
import { categories as categoriesData, tasks as tasksData, taskSteps as taskStepsData } from 'app/mock-api/apps/browse-task/data';
...
export class TaskMockApi
{
    ...
    registerHandlers(): void
    {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onGet('api/post-browse-task/browse-task')
            .reply(({request}) => {
