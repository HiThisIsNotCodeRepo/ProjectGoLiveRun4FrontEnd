            ...
            .subscribe((tasks: Task[]) => {
                ...
                setTimeout(() => {
                    ...
                    if ( mainNavigationComponent )
                    {
                        ...
                        const menuItem = this._fuseNavigationService.getItem('apps.post-browse-task', mainNavigation);

                        // Update the subtitle of the item
                        menuItem.subtitle = this.tasksCount.incomplete + ' remaining post-browse-task';
